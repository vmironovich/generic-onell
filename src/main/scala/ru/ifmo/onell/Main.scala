...
import ru.ifmo.onell.main.{FixedBudget, FixedTarget, LambdaColorMap, LambdaTraces, RunningTimes}
...
object Main {
  ...
  private val modules = Seq(Help, RunningTimes, FixedBudget, FixedTarget, LambdaColorMap, LambdaTraces)
