...
/**
  ...
  * @tparam ChangeType the type of the single change (e.g. the index to flip a bit at).
  * @tparam FitnessType the type of the fitness value.
  */
trait HasIncrementalEvaluation[
  MutableIndividual,
  @specialized(cs) ChangeType,
  @specialized(cs) ChangeSizeType,
  ...
  /**
    ...
    */
  def numberOfChangesForProblemSize(problemSize: Int): ChangeSizeType
  ...
  /**
    ...
    */
  def sizeTypeToLong(st: ChangeSizeType): Long
  ...
  /**
    ...
    */
  def applyDelta(ind: MutableIndividual, delta: OrderedSet[ChangeType], currentFitness: FitnessType): FitnessType
  ...
  /**
    ...
    */
  def unapplyDelta(ind: MutableIndividual, delta: OrderedSet[ChangeType]): Unit
  ...
  /**
    ...
    */
  def evaluateAssumingDelta(ind: MutableIndividual, delta: OrderedSet[ChangeType],
